---
applyTo: "README.md,docs/**,New-docs/**,AGENTS.md,CLAUDE.md,.github/**,.claude/skills/**,scripts/**,docker/**"
---
...
- Root `SKILL.md` and `New-docs/integrations/openclaw-skill-integration.md` describe product or external integration behavior, not repository governance.
