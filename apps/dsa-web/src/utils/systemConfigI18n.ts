...
const fieldTitleMap: Record<string, string> = {
  ...
  JOURNAL_AI_MODEL: '交易复盘专用模型',
  JOURNAL_AI_FALLBACK_MODELS: '交易复盘备用模型',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  JOURNAL_AI_MODEL: '只用于仓位复盘的主模型，格式为 provider/model。留空时继承 Agent 模型链。',
  JOURNAL_AI_FALLBACK_MODELS: '仓位复盘专用备用模型，逗号分隔；显式留空表示模型失败时不继续回退。',
