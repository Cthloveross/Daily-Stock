...
|----------|-------------|
| [README (EN)](../user-guide/README_EN.md) | Project overview, quick start, features, sample output |
| [Full Guide (EN)](../user-guide/full-guide_EN.md) | Complete setup and usage walkthrough |
| [Deploy Guide (EN)](../deployment/DEPLOY_EN.md) | Server deployment (Docker, systemd, Supervisor) |
| [LLM Config Guide (EN)](../configuration/LLM_CONFIG_GUIDE_EN.md) | AI model configuration (Gemini, OpenAI-compatible, DeepSeek, Ollama, etc.) |

## ❓ Help & Troubleshooting

| Document | Description |
|----------|-------------|
| [FAQ (EN)](../user-guide/FAQ_EN.md) | Frequently asked questions and common errors |

## 🤖 Bot Integration

| Document | Description |
|----------|-------------|
| [Bot Commands (EN)](../integrations/bot-command_EN.md) | Bot architecture, commands, webhook routes, Feishu / DingTalk integration |
...
| Document | Description |
|----------|-------------|
| [Changelog](../../docs/CHANGELOG.md) | Version history and release notes (maintained in Chinese with English summaries) |
...
*Last updated: see [CHANGELOG.md](../../docs/CHANGELOG.md)*
