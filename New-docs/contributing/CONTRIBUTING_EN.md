...
When modifying a Chinese-language core document (e.g., `New-docs/user-guide/full-guide.md`), your PR description **must state** whether the corresponding English document has been updated. If not updated, explain why.
