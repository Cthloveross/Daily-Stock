...
> Full details: [LLM Config Guide](../configuration/LLM_CONFIG_GUIDE_EN.md).
...
**Pitfall**: Do not use `OPENAI_BASE_URL` for Ollama, or the system will concatenate URLs incorrectly (e.g. 404, `api/generate/api/show`). See [LLM Config Guide](../configuration/LLM_CONFIG_GUIDE_EN.md) Example 4 and channel examples.
...
> See [LLM Config Guide → Example 4 (Ollama)](../configuration/LLM_CONFIG_GUIDE_EN.md#example-4-ollama) for a complete configuration example.
...
1. Check [Complete Configuration Guide](../user-guide/full-guide_EN.md)
2. Search or submit [GitHub Issue](https://github.com/ZhuLinsen/daily_stock_analysis/issues)
3. Check [Changelog](../../docs/CHANGELOG.md) for latest fixes
