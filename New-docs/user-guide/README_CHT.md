...
[**功能特性**](#-功能特性) · [**快速開始**](#-快速開始) · [**推送效果**](#-推送效果) · [**完整指南**](./full-guide.md) · [**常見問題**](./FAQ.md) · [**更新日誌**](../../docs/CHANGELOG.md)

 繁體中文 | [English](../user-guide/README_EN.md) | [简体中文](../README.md)
...
> 詳細配置請參考 [LLM 配置指南](../configuration/LLM_CONFIG_GUIDE.md)。預設路徑是先選服務商、填 API Key，再視需要補主模型；只有需要多模型切換時才啟用渠道模式，高級 YAML 路由則留給進階用戶。
...
- [x] 釘釘機器人 （已支持命令交互 >> [相關配置](../integrations/bots/dingding-bot-config.md)）
### 🤖 AI 模型支持
...
詳見 [貢獻指南](../contributing/CONTRIBUTING.md)
