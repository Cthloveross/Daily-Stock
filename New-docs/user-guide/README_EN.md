...
[**Quick Start**](#-quick-start) · [**Key Features**](#-key-features) · [**Sample Output**](#-sample-output) · [**Full Guide**](./full-guide_EN.md) · [**FAQ**](./FAQ_EN.md) · [**Contributing**](../contributing/CONTRIBUTING_EN.md) · [**All Docs**](../contributing/INDEX_EN.md)

English | [简体中文](../README.md) | [繁體中文](../user-guide/README_CHT.md)
...
> For detailed configuration, see [LLM Config Guide](../configuration/LLM_CONFIG_GUIDE_EN.md). The default path is: pick a provider, add the API key, then optionally pin a primary model. Use channels only when you need multi-provider routing or fallbacks; advanced YAML routing is optional for expert setups.
...
- [FAQ](./FAQ_EN.md)
- [Deployment Guide](../deployment/DEPLOY_EN.md)
- [Bot Command Reference](../integrations/bot-command.md)
- [Feishu Bot Setup](../integrations/bots/feishu-bot-config.md)
- [DingTalk Bot Setup](../integrations/bots/dingding-bot-config.md)
